...
const PhotoList = ({ category }) => {
  const [photos] = useState([
    ...
    },
    {
      name: 'Trail Talk',
      category: 'portfolio',
      description: 'Interactive full-stack MERN group project using REACT, MongoDB, GraphQL.  A social media-type app where people can talk about the national parks they have visited.',
